...
},{}],"js/stripe.js":[function(require,module,exports) {
"use strict";
...
},{"./display":"js/display.js","./firebaseChecks":"js/firebaseChecks.js"}],"js/componentse.js":[function(require,module,exports) {
"use strict";
...
},{"./firebaseChecks":"js/firebaseChecks.js"}],"js/playback.js":[function(require,module,exports) {
"use strict";
...
},{"./componentse":"js/componentse.js","./display":"js/display.js","./firebaseChecks":"js/firebaseChecks.js","./playback":"js/playback.js"}],"js/sounds.js":[function(require,module,exports) {
"use strict";
...
},{"./display":"js/display.js","./vcMusic":"js/vcMusic.js","./settings":"js/settings.js","./friends":"js/friends.js","./electron":"js/electron.js","./sounds":"js/sounds.js","./firebaseChecks":"js/firebaseChecks.js"}],"js/settings.js":[function(require,module,exports) {
"use strict";
...
},{"./componentse":"js/componentse.js","./display":"js/display.js","./firebaseChecks":"js/firebaseChecks.js","./friends":"js/friends.js","./music":"js/music.js","./presence":"js/presence.js","./servers":"js/servers.js","./stripe":"js/stripe.js"}],"js/friends.js":[function(require,module,exports) {
"use strict";
...
},{"./display":"js/display.js","./presence":"js/presence.js","./stripe":"js/stripe.js","./voice":"js/voice.js","./users":"js/users.js","./electron":"js/electron.js","./settings":"js/settings.js","./sounds":"js/sounds.js","./servers":"js/servers.js","./firebaseChecks":"js/firebaseChecks.js"}],"js/library.js":[function(require,module,exports) {
"use strict";
...
},{"./app":"js/app.js","./componentse":"js/componentse.js","./display":"js/display.js","./electron":"js/electron.js","./firebaseChecks":"js/firebaseChecks.js","./music":"js/music.js","./stripe":"js/stripe.js"}],"js/display.js":[function(require,module,exports) {
"use strict";
    ...
    switch (e.code) {
      ...
      case 'Enter':
        ...
        if (modalOpen) {
          ...
          (0, _display.closeEmojiPicker)(emojiPickerOpen);
        } else if (gifPickerOpen) {
          (0, _display.closeGifPicker)(gifPickerOpen);
      ...
      case 'Escape':
        ...
        if (modalOpen) {
          ...
          (0, _display.fadeOutFullscreenImage)();
        } else if (document.activeElement.classList.contains('playlistDescription')) {
          document.activeElement.blur();
        }
      ...
      case 'ArrowUp':
        if (currentServer == 'friends') {
          if (currentChannel) {
            (0, _friends.prepareDMEditMessage)(currentChannel, $(`#DMMessages${currentChannel}`).children('.selfChatMessage').last().children('.topLevelMessageContentTwo').last().children('.relative').last().children('.messageContentContentContainer').last().attr('messageID'));
          }
        } else if (currentChannel) {
          const scopedActiveChannel = `${currentServerUser}${currentServer}${currentChannel}`;
          (0, _channels.prepareEditMessage)(scopedActiveChannel, $(`#${scopedActiveChannel}ChatMessages`).children('.selfChatMessage').last().children('.topLevelMessageContentTwo').last().children('.relative').last().children('.messageContentContentContainer').last().attr('messageID'));
        }
...
},{"./app":"js/app.js","./channels":"js/channels.js","./display":"js/display.js","./electron":"js/electron.js","./friends":"js/friends.js"}]},{},["js/keyboarde.js"], null)