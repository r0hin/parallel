...
exports.createAccount = functions.https.onCall(async (data, context) => {
  ...
  await db.collection("users").doc(uid).set({
    ...
    playlistFoldersSort: [],
    uid: uid,
    url: "https://firebasestorage.googleapis.com/v0/b/parallel-by-wop.appspot.com/o/pfp%2F" + uid + "%2Fprofile.png?alt=media"
  }, { merge: true });
